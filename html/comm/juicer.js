...
(function() {
    ...
    var __escapehtml = {
        ...
        currencyInt:function(numOrStr){
            return __escapehtml.currency(numOrStr).slice(0,-3);
        }
    };
    ...
    juicer.options = {
        ...
        _method: __creator({
            ...
            __throw: __throw,
            __juicer: juicer,
            currency: __escapehtml.currency,
            currencyInt: __escapehtml.currencyInt
        }, {})
    };
    ...
    juicer.template = function(options) {
        ...
        this.__lexicalAnalyze = function(tpl) {
            ...
            var prefix = '';
            var reserved = [
                'if','else', 'each', '_', '_method', 'console',
